...
const FullscreenModalForm: React.FC<Props> = (props) => {
  switch (props.state) {
    ...
    case `custom`:
      return (
        <FullscreenGradientBg>
          <div className="bg-white font-sans max-w-lg rounded-2xl mx-4 pt-8 pl-7 pr-8 shadow-lg flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 relative items-center sm:items-start pb-6">
            <GradientIcon
