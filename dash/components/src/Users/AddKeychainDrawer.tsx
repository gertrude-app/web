        ...
        return (
          <div className="w-full h-full flex justify-center items-center">
            <div className="flex flex-col items-center p-12 bg-slate-100 rounded-3xl">
              <div className="w-14 h-14 bg-slate-200 rounded-full flex justify-center items-center mb-4">
                <i className="fa-solid fa-cow text-2xl text-slate-400" />
              </div>
      ...
      case request?.state === `succeeded` &&
        ...
        return (
          <div className="w-full h-full flex justify-center items-center">
            <div className="flex flex-col items-center p-12 bg-slate-100 rounded-3xl">
              <div className="w-14 h-14 bg-slate-200 rounded-full flex justify-center items-center mb-4">
                <i className="fa-solid fa-key text-2xl text-slate-400" />
              </div>
              <h2 className="text-xl font-medium text-slate-500">
    ...
    >
      ...
      >
        ...
        <footer className="border-t border-slate-200 bg-white p-6">
          <div className="flex justify-start items-center gap-2 pb-4 h-[52px]">
            {schedule ? (
              <>
          ...
          <div className="flex justify-between items-end gap-8 w-full">
            <div className="flex flex-col flex-grow">
              ...
              <div className="mt-1 mb-2">
                <h3
                  className={cx(
                    `text-xl font-semibold flex gap-1 absolute`,
                    !showNew
                ...
                <h3
                  className={cx(
                    `text-xl font-semibold flex gap-1`,
                    showNew &&
              ...
              <div className="w-full bg-slate-100 rounded-lg p-2 h-[120px] overflow-hidden relative">
                <p
                  className={cx(
                    `absolute`,
                    !showNew
