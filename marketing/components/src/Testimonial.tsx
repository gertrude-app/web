...
const Testimonial: React.FC<Props> = ({ children, name, index, testimonialIndex }) => {
  return (
    ...
    >
      <div className="w-[calc(100vw-140px)] md:max-w-xl lg:max-w-2xl flex flex-col items-center relative">
        <i className="fa-solid fa-quote-left absolute text-6xl text-gray-200 -left-16 -top-8" />
        <i className="fa-solid fa-quote-right absolute text-6xl text-gray-200 -right-16 bottom-4" />
