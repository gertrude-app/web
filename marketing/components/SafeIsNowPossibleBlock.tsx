...
import RadBlock from "./RadBlock";

interface Props {}

const SafeIsNowPossibleBlock: React.FC<Props> = ({}) => {
  return (
      ...
      <section className="relative lg:ml-20 lg:border-gray-400 lg:border-opacity-50 lg:border-l-2 lg:border-dashed">
        ...
        <div className="lg:p-20 p-10 py-20">
          ...
          <p className="text-xl text-gray-500 mt-8 leading-8">
            Gertrude blocks the entire internet, only allowing parts you
            specifically unlock. We make this managable by letting you:
          </p>
          <div className="flex flex-wrap justify-center items-stretch py-10 pb-0 lg:pb-10 -mx-7 sm:-mx-0">
            <Feature icon={"mobile"}>
              Unlock websites and apps from wherever you are, on your own
              computer or phone
            </Feature>
            <Feature icon={"share"}>
            ...
            <Feature icon={"bell"}>
              Get text, email, or Slack notifications wherever you are when
              someone needs something unblocked
            </Feature>
            <Feature icon={"eye"}>
