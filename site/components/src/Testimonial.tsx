...
const Testimonial: React.FC<Props> = ({ children, name, index, testimonialIndex }) => (
  ...
  >
    <div className="mx-8 sm:mx-0 -translate-y-4 w-full sm:w-[calc(100vw-140px)] md:max-w-xl lg:max-w-2xl flex flex-col items-center relative">
      <i className="fa-solid fa-quote-left absolute text-6xl text-slate-100 sm:text-slate-200 -left-8 sm:-left-16 -top-8" />
      <i className="fa-solid fa-quote-right absolute text-6xl text-slate-100 sm:text-slate-200 -right-8 sm:-right-16 bottom-4" />
