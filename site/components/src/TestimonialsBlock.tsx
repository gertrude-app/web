...
const TestimonialsBlock: React.FC = () => (
  <section className="px-8 bg-gradient-to-b from-white to-violet-500">
    <div className="bg-slate-900 p-28 pb-40 relative flex justify-center items-center overflow-hidden gap-12">
      <TestimonialCard
      ...
      <TestimonialCard name="Jared Henderson" placeOfWork="Gertrude" className="rotate-6">
...
const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  <div
    className={cx(`bg-slate-800 p-12 rounded-3xl flex flex-col items-center`, className)}
  >
