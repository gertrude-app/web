...
const styles = {
  note: {
    ...
    body: `[--tw-prose-background:theme(colors.violet.50)] prose-a:text-violet-500 text-slate-500 prose-code:text-slate-500 prose-strong:text-slate-900 prose-em:text-slate-900`,
  },
  warning: {
