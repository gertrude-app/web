...
The Gertrude marketing site uses a bold, modern design centered around vibrant violet and fuchsia gradients, creating a confident and tech-forward brand identity.
...
### Brand Gradients
- **Violet to Fuchsia**: `from-violet-500 to-fuchsia-500` or `from-violet-600 to-fuchsia-500`
...
**Standard Logo**
- Icon + "Gertrude" wordmark
- Default: Gradient fill (violet to fuchsia)
- Inverted: White fill
- Font: Lato 900
- Size: Default 53px (configurable)

**Logo Variants**
- Icon only mode
- "For Parents" tagline option
- Multiple text sizes
- Gradient or inverted color schemes
