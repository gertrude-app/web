...
Default.args = {
  ...
  description:
    'Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam in, quam, modi quibusdam cupiditate labore illum dolorum doloribus, voluptates veritatis quis laborum.',
  selected: false,
  badges: [],
};
