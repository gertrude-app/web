      ...
      <div className="lg:max-w-8xl mx-auto grid max-w-2xl grid-cols-1 items-center gap-y-16 gap-x-8 px-4 lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
        <div className="relative z-10 md:text-center lg:text-left">
          ...
          <div className="relative">
            <p className="font-display inline bg-gradient-to-r from-indigo-200 via-violet-400 to-indigo-200 bg-clip-text text-5xl tracking-tight text-transparent">
                ...
                <div className="mt-6 flex items-start px-1 text-sm">
                  ...
                  >
                    {({ className, style, tokens, getLineProps, getTokenProps }) => (
                      <pre
                        className={cx(className, `flex overflow-x-auto pb-6`)}
                        style={style}
                      >
                        <code className="px-4">
...
const TrafficLightsIcon: React.FC<{ className?: string }> = ({ className }) => (
