...
const Welcome: React.FC<Props> = ({ emit }) => {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center bg-gradient-to-b from-fuchsia-500 to-violet-500 overflow-hidden relative">
      <div
        className={cx(
      ...
      >
        <button
          className={
            'flex items-center justify-center gap-3 bg-white px-10 py-5 rounded-2xl text-xl font-semibold shadow-lg hover:opacity-90 transiton-[opacity,transform] duration-200 active:scale-[98%] active:shadow-md'
          }
