    ...
    case `installSysExt_allow`:
      return (
        <Onboarding.Centered className="space-x-12" direction="row">
          <Onboarding.HighContrastArea className="flex flex-col">
        ...
        <Onboarding.Centered>
          <Onboarding.HighContrastArea className="flex flex-col items-center">
            ...
            <Onboarding.Text className="max-w-2xl" centered>
              Shucks! The system extension did not install correctly. Watch this short
              video for troubleshooting tips.
            </Onboarding.Text>
            <iframe
