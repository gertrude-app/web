...
const UpdateRequired: React.FC<Props> = ({ emit }) => (
  <MenuBarSized className="flex flex-col justify-center items-center px-8">
    ...
    <button
      ...
      className="flex items-center text-lg font-bold bg-violet-500/90 dark:bg-violet-700/90 px-7 py-3 mt-6 rounded-xl shadow-md transition duration-100 hover:bg-violet-600/90 dark:hover:bg-violet-800/90 hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0 active:shadow"
    >
