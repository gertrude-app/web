...
export default function AppWindow<T>({
  ...
  return (
    <div
      className={cx(
        `shadow-lg flex flex-col border-[0.5px] rounded-lg border-slate-300`,
        dark && `dark`,
      )}
      style={{ height, width }}
    >
      <div className="flex items-center pl-2 space-x-1.5 bg-[rgb(239,237,242)] dark:bg-[rgb(54,51,57)] h-[28px] rounded-t-lg border-b-[0.5px] border-slate-300 dark:border-slate-600 shrink-0">
